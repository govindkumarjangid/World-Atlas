...
export const SearchFilter = (props) => {
    ...
    return <motion.section
        ...
        className="relative z-20 mb-10 grid gap-6 rounded-xl border border-cyan-500/20 bg-slate-900/60 p-5 shadow-lg backdrop-blur-xl md:grid-cols-[1fr_auto] md:items-center"
    >
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            <div className="relative group" ref={dropdownRef}>
                ...
                <button
                    ...
                    className="flex w-44 items-center justify-between rounded-xl border border-slate-700/50 bg-slate-950/50 py-2.5 pl-3 pr-3 text-sm font-medium text-slate-200 outline-none transition-all hover:border-slate-600 focus:border-cyan-400 focus:bg-slate-900/80 cursor-pointer"
                >
                ...
                <motion.div
                    ...
                    className="absolute right-0 top-full z-50 mt-2 w-full overflow-hidden rounded-xl border border-slate-700/50 bg-slate-900 p-2 shadow-[0_10px_25px_rgba(0,0,0,0.5)] space-y-1"
                >
                    {[
                        ...
                        <button
                            ...
                            className={`block w-full px-4 py-2.5 text-left text-sm transition-colors rounded-xl ${filter === option.value

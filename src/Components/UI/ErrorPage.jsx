    ...
    return (
        <section className="flex min-h-screen flex-col items-center justify-center bg-slate-950 px-4 py-20 text-center sm:px-6 lg:px-8">
            <motion.div
                ...
                className="relative w-full max-w-2xl overflow-hidden rounded-2xl border border-white/10 bg-slate-900/60 p-10  backdrop-blur-2xl"
            >
                ...
                >
                    <button
                        onClick={() => navigate(-1)}
                        className="group flex w-full items-center justify-center gap-2 rounded-lg border border-slate-700 bg-slate-800 px-6 py-3 text-sm font-semibold text-slate-200 transition-all hover:bg-slate-700 hover:text-white sm:w-auto"
                    >
                    ...
                    <button
                        onClick={() => navigate('/')}
                        className="group flex w-full items-center justify-center gap-2 rounded-lg border border-cyan-400/50 bg-cyan-500/10 px-6 py-3 text-sm font-semibold text-cyan-300 transition-all hover:bg-cyan-500/20 sm:w-auto"
                    >
